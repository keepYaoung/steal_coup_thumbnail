...
로컬 Download 폴더 내 날짜별 폴더(예: `26-03-31-coupang-thumbnail`)에 일괄 저장해주는 크롬 확장 프로그램입니다.

---

## 주요 기능
- 구글 시트에서 **쿠팡 링크가 있는 열 전체 복사** → 확장 프로그램에 붙여넣기 → 썸네일 일괄 다운로드
- 썸네일 이미지는 `YY-MM-DD-coupang-thumbnail/crawl_img_1.jpg`, `crawl_img_2.jpg` ... 형식으로 날짜별 폴더에 저장
- 간단하고 직관적인 카드형 UI
...
4. "썸네일 다운로드" 버튼 클릭
5. Download 폴더 내 날짜별 폴더(예: `26-03-31-coupang-thumbnail`)에 썸네일 이미지가 자동 저장됨

---

## 다운로드 폴더 구조
```
~/Downloads/26-03-31-coupang-thumbnail/
  ├─ crawl_img_1.jpg
  ├─ crawl_img_2.jpg
  ├─ ...
```
